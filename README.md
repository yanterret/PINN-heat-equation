...
Ce repo sert avant tout de tutoriel pour s'emparer des techniques de résolution par PINN pour ensuite s'attaquer à des problémes ou il sera pertinent de l'utiliser.
